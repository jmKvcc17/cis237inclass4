    ...
    class IntegerLinkedList : IIntegerLinkedList
    {
        ...
        public int RemoveMaintainSort(int RemoveData)
        {
            ...
            if (_head == _tail || _head.Data == RemoveData)
            {
                ...
                //If the head is null, then the list must be empty
                //and the tail should become null as well
                if (_head == null)
                {
                    _tail = null;
                }
            ...
            else
            {
                ...
                //and the currentNode's data is not what we want
                //to remove
                ...
                {
                    //Since it's what we want, lets set it
